...
public class VipsUtil {
    ...
    static String windowsCommand = "/usr/local/bin/vipsthumbnail";
    static String linuxCommand = "/usr/local/bin/vipsthumbnail";
    //生成缩略图
    public static void thumbnail(String srcPath, String desPath, int tarWidth , int tarHight, String quality) {
